...
final public class CustomViewWithCollectionView: UIView {
    fileprivate lazy var containerView = UIView().parent(view: self)
    public lazy var collectionView = UICollectionView(frame: .zero, collectionViewLayout: UICollectionViewLayout()).parent(view: containerView)
    ...
    public var tryAgainBtnDidTapped: (() -> Void)?
...
extension CustomViewWithCollectionView {
    public func registerCell(cell: UICollectionViewCell.Type, identifier: String) {
        collectionView.register(cell.self, forCellWithReuseIdentifier: identifier)
    }

    public func setCellTag(tag: Int) {
        collectionView.tag = tag
    }

    public func setState(_ state: ViewState) {
        switch state {
        case .loading:
    ...
    public func updateCollectionViewHeight(_ height: Float) {
        collectionView.snp.updateConstraints { make in
            make.height.equalTo(height)
        }
    }

    public func setCollectionViewFlowLayout(_ layout: UICollectionViewLayout) {

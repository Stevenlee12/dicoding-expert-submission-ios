...
final class HomeView: UIView {
    ...
    public lazy var recommendedGameView = CustomViewWithCollectionView().parent(view: recommendedView)
...
//            layout.estimatedItemSize = CGSize(width: 1, height: 1000)
        ...
        gameGenreView.style {
            $0.backgroundColor = .cardColor // UIColor(red: 31/255, green: 36/255, blue: 48/255, alpha: 1)
